...
public class MyPageViewHandler {
    ...
    public void whenOrderPlaced_then_CREATE_1(
        ...
        try {
            ...
            myPage.setUserId(String.valueOf(orderPlaced.getCustomerId()));
            myPage.setOrderQty(orderPlaced.getOrderQty());
    ...
    public void whenDeliveryStarted_then_UPDATE_1(
        ...
        try {
            ...
            for (MyPage myPage : myPageList) {
                ...
                myPage.setStatus(deliveryStarted.getOrderStatus());
                // view 레파지 토리에 save
                myPageRepository.save(myPage);
            }
        } catch (Exception e) {
    ...
    public void whenDeliveryCanceled_then_UPDATE_2(
        ...
        try {
            ...
            for (MyPage myPage : myPageList) {
                // view 객체에 이벤트의 eventDirectValue 를 set 함
                myPage.setStatus(deliveryCanceled.getOrderStatus());
                // view 레파지 토리에 save
                myPageRepository.save(myPage);
            }
        } catch (Exception e) {
